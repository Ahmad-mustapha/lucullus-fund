  ...
  return (
    <section style={{padding: '2rem'}} className='flex items-center gap-8 justify-center flex-wrap-reverse md:flex-nowrap'>
      ...
      <div className='w-full sm:w-5/6 md:w-3/6 leading-[20px] md:leading-[30px] lg:leading-[46px]'>
          <h2 style={{marginBottom: '1rem'}} className='text-[#094C41] font-[700] text-[17px] md:text-[28px] lg:text-[39px] text-center md:text-left'>Are you an Individual Investor or Institution Allocator looking to Meet our Team</h2>
